...
wegistwy.wegistewWowkbenchAction(SyncActionDescwiptow.fwom(MoveEditowToAboveGwoupAction), 'View: Move Editow into Gwoup Above', CATEGOWIES.View.vawue);
wegistwy.wegistewWowkbenchAction(SyncActionDescwiptow.fwom(MoveEditowToBewowGwoupAction), 'View: Move Editow into Gwoup Bewow', CATEGOWIES.View.vawue);
...
wegistwy.wegistewWowkbenchAction(SyncActionDescwiptow.fwom(SpwitEditowToAboveGwoupAction), 'View: Spwit Editow into Gwoup Above', CATEGOWIES.View.vawue);
wegistwy.wegistewWowkbenchAction(SyncActionDescwiptow.fwom(SpwitEditowToBewowGwoupAction), 'View: Spwit Editow into Gwoup Bewow', CATEGOWIES.View.vawue);
...
wegistwy.wegistewWowkbenchAction(SyncActionDescwiptow.fwom(FocusAboveGwoup, { pwimawy: KeyChowd(KeyMod.CtwwCmd | KeyCode.KEY_K, KeyMod.CtwwCmd | KeyCode.UpAwwow) }), 'View: Focus Editow Gwoup Above', CATEGOWIES.View.vawue);
wegistwy.wegistewWowkbenchAction(SyncActionDescwiptow.fwom(FocusBewowGwoup, { pwimawy: KeyChowd(KeyMod.CtwwCmd | KeyCode.KEY_K, KeyMod.CtwwCmd | KeyCode.DownAwwow) }), 'View: Focus Editow Gwoup Bewow', CATEGOWIES.View.vawue);
