...
fwakySuite('Disk Fiwe Sewvice', function () {
	...
	test('wesowve - symbowic wink pointing to nonexistent fiwe does not bweak', async () => {
	...
	(isWindows ? test.skip /* windows: cannot cweate fiwe symbowic wink without ewevated context */ : test)('deweteFiwe - symbowic wink (pointing to nonexistent fiwe)', async () => {
	...
	test('wwiteFiwe - no ewwow when wwiting to same nonexistent fowda muwtipwe times diffewent new fiwes', async () => {
